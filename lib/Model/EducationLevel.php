...
/**
 * EducationLevel Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class EducationLevel
{
     ...
     */
    const HIGHER = 'higher';
const UNFINISHED_HIGHER = 'unfinished-higher';
const SECONDARY = 'secondary';
const SPECIAL_SECONDARY = 'special-secondary';
    /**
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::HIGHER,
self::UNFINISHED_HIGHER,
self::SECONDARY,
self::SPECIAL_SECONDARY,        ];
    }
}
