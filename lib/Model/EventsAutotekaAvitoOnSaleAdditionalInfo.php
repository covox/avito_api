...
/**
 * EventsAutotekaAvitoOnSaleAdditionalInfo Class Doc Comment
 *
 * @category Class
 * @description Доп информация по объявению
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EventsAutotekaAvitoOnSaleAdditionalInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EventsAutoteka_avitoOnSale_additionalInfo';
...
'url' => 'getUrl'    ];
     ...
     * Sets date
     *
     * @param int $date Дата последнего обновления
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title Заголовк объявления
     *
     * @return $this
     */
