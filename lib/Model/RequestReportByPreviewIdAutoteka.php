...
/**
 * RequestReportByPreviewIdAutoteka Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestReportByPreviewIdAutoteka implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestReportByPreviewIdAutoteka';
     ...
     * Sets preview_id
     *
     * @param int $preview_id Идентификатор превью.
     *
     * @return $this
     */
