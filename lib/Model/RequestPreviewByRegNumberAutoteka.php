...
/**
 * RequestPreviewByRegNumberAutoteka Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestPreviewByRegNumberAutoteka implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestPreviewByRegNumberAutoteka';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reg_number'] === null) {
            $invalidProperties[] = "'reg_number' can't be null";
        }
