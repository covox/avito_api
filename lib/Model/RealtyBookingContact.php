...
/**
 * RealtyBookingContact Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RealtyBookingContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RealtyBooking_contact';
...
'email' => 'getEmail'    ];
     ...
     * Sets phone
     *
     * @param string $phone Номер телефона в 10-ти значном формате (только цифры)
     *
     * @return $this
     */
