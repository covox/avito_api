...
/**
 * AutotekaApiTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutotekaApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test case for getActivePackage
     *
     * Метод для запроса остатка отчётов в текущем пакете пользователя.
     *
     */
    public function testGetActivePackage()
    {
    }
    ...
    /**
     * Test case for postPreviewByRegNumber
     *
     * Запрос на создание превью по государственному номеру.
     *
     */
    public function testPostPreviewByRegNumber()
    {
    }

    /**
     * Test case for postPreviewByVin
     *
     * Запрос на создание превью по VIN.
     *
     */
    public function testPostPreviewByVin()
    {
    }
